    ...
    return (
        <div>
            ...
            <div className="overflow-x-auto p-6 mt-12 shadow-lg rounded-lg">
                <h2 className="text-3xl font-semibold py-4">TOTAL USER: {users.length}</h2>
          ...
          <tbody>
            {users.map((user, idx) => (
              <tr className="text-center" key={user._id}>
                ...
                <th>
                <button onClick={()=> handleDelete(user._id)} className="btn btn-ghost bg-orange-400 hover:bg-orange-500 text-white">
                        <FaUsers></FaUsers>
                   </button>
                </th>
                <th>
                   <button onClick={()=> handleDelete(user._id)} className="btn btn-ghost  text-red-600">
                       <FaTrash></FaTrash>
                   </button>
                </th>
              </tr>
